...
export default function Table() {
  ...
  return (
    <section class="flex-wrap antialiased justify-center  bg-gray-100 text-gray-600 h-screen px-4">
      <div class="flex flex-wrap flex-col align-middle justify-center h-full">
                            ...
                            <tr>
                                <td class="p-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-20 h-20 object-fill flex-shrink-0 mr-2 sm:mr-3"><img class="h-20 w-6w rounded-lg" src={trip.img_sml} width="150" height="70" alt="Alex Shatov"/></div>
                                    </div>
                                </td>
                                <td class="p-2 whitespace-nowrap">
